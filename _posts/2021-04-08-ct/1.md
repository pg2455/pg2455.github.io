...
series:
  name: ct
  id: 1
  previous_page_title: Contact tracing as a personalization framework
  next_page_title: Search for a unified framework
_styles: "h3, h2, h1 {\n  padding-top: 0!important;\n}\n"
distill: true
mathjax: true
bibliography: ct.bib
summary: "<ul>\n  <li><em>A Test-and-Trace system is a band-aid solution to open up\
  \ the economy while controlling the outbreak</em></li>\n  <li><em>A framework that\
  \ combines the strengths of the manual and digital systems will help devise better\
  \ solutions</em></li>\n</ul>\n"
comments: false
---
### Trade-off
