...
series:
  name: ct
  id: 2
  previous_page_title: Why do we need contact tracing?
  next_page_title: Framework in practice
_styles: "h3, h2, h1 {\n  padding-top: 0!important;\n}\n"
distill: true
mathjax: true
bibliography: ct.bib
summary: "<ul>\n  <li><em>A framework should incorporate knowledge from the related\
  \ domains of epidemiology, virology, privacy, user-behavior, public policy, and\
  \ computer science </em></li>\n  <li><em>The framework should react to the information\
  \ as it is observed, thereby enabling early warning signals</em></li>\n</ul>\n"
comments: false
---
### Motivation
