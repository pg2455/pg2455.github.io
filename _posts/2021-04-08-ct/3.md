...
series:
  name: ct
  id: 3
  previous_page_title: Search for a unified framework
  next_page_title: Deep learning for the framework
_styles: "h3, h2, h1 {\n  padding-top: 0!important;\n}\n"
distill: true
mathjax: true
bibliography: ct.bib
summary: "<ul>\n  <li><em>Several rule-based predictors and recommenders for PCT framework\
  \ are discussed</em></li>\n</ul>\n"
comments: false
---
### Setup
