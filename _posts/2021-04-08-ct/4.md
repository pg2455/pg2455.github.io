...
series:
  name: ct
  id: 4
  previous_page_title: Framework in practice
  next_page_title: Limitations and Open Questions
_styles: "h3, h2, h1 {\n  padding-top: 0!important;\n}\n"
distill: true
mathjax: true
bibliography: ct.bib
summary: "<ul>\n  <li><em>A generative model can be used to collect data to train\
  \ a deep learning based predictor</em></li>\n</ul>\n"
comments: false
---
