...
Map image paths -> relative URLs
    i.e. "/Users/Desktop/_posts/YYYY-MM-DD-post-name/images/image.png" => "images/image.png"
'''
def path2support(path: str):
    image_file_name: str = os.path.basename(path)
    image_path: str = f"/images/blog/{base_file_name_with_date_prefix}/" + image_file_name
    return image_path
